...
export function HuntTypeToggle({
  mode,
  onSelect,
}: {
  mode: JobMode;
  onSelect: (m: JobMode) => void;
}) {
  ...
  const handleTypeSelect = (id: JobMode) => (): void => onSelect(id);

  return (
    <div
      className="relative flex gap-2 rounded-2xl bg-gray-100 p-1"
      role="radiogroup"
