  ...
  return (
    <Section title="Дебаг">
      ...
      <p className="rounded-lg bg-amber-50 p-3 text-xs leading-relaxed text-amber-800">
        Щоб зловити редірект з кошика: увімкніть запис, відтворіть бронювання й відкриття
        кошика, потім експортуйте файл. JWT‑токени приховуються автоматично, але файл може
        містити дані бронювання (маршрут, cart, x-session-id) — перегляньте перед тим, як
        ділитися.
      </p>
    </Section>
  );
