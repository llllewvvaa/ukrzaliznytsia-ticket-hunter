...
export function Select({
  ...
  // Hover should move the same highlight the arrow keys drive.
  const highlightOption = (index: number) => (): void => setActiveIdx(index);

  const chooseOption = (v: string) => (): void => choose(v);
        ...
        >
          {options.map((o, i) => (
            <li
              ...
              onMouseEnter={highlightOption(i)}
