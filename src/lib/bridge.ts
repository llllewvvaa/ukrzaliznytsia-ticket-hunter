...
export function isCaptchaResolvedMessage(
  msg: unknown,
): msg is CaptchaResolvedMessage {
  return (
    typeof msg === 'object' &&
    msg !== null &&
  ...
  return {
    call<T = unknown>(method: string, params?: unknown, timeoutMs = 30_000): Promise<T> {
      ...
      return new Promise<T>((resolve, reject) => {
        ...
        const req: RpcRequest = { kind: 'req', id, method, ...(params !== undefined ? { params } : {}) };
...
export function serveInContentScript(
