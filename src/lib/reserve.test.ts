...
import type { HuntJob, Passenger, ReserveOutcome, Trip, Wagon } from './models';
...
describe('buildReservations', () => {
  it('maps passengers to seats and adds bedding when enabled', () => {
    ...
    expect(res[0]).toMatchObject({ passenger_id: 1, seat_number: 28, first_name: 'Ivan', wagon_id: 'enc-wagon' });
